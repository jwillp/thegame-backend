 ...
 */
class Version20170927031455 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE challenge_batch (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, game_id INT NOT NULL, INDEX IDX_FCD9DBC6A76ED395 (user_id), INDEX IDX_FCD9DBC6E48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE challenge_batch_challenge (challenge_batch_id INT NOT NULL, challenge_id INT NOT NULL, INDEX IDX_C3EAB4D46EA0599A (challenge_batch_id), INDEX IDX_C3EAB4D498A21AC6 (challenge_id), PRIMARY KEY(challenge_batch_id, challenge_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE challenge_batch ADD CONSTRAINT FK_FCD9DBC6A76ED395 FOREIGN KEY (user_id) REFERENCES fos_user (id)');
        $this->addSql('ALTER TABLE challenge_batch ADD CONSTRAINT FK_FCD9DBC6E48FD905 FOREIGN KEY (game_id) REFERENCES game (id)');
        $this->addSql('ALTER TABLE challenge_batch_challenge ADD CONSTRAINT FK_C3EAB4D46EA0599A FOREIGN KEY (challenge_batch_id) REFERENCES challenge_batch (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE challenge_batch_challenge ADD CONSTRAINT FK_C3EAB4D498A21AC6 FOREIGN KEY (challenge_id) REFERENCES challenge (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE challenge_batch_challenge DROP FOREIGN KEY FK_C3EAB4D498A21AC6');
        $this->addSql('ALTER TABLE score DROP FOREIGN KEY FK_3299375198A21AC6');
        $this->addSql('ALTER TABLE challenge_batch_challenge DROP FOREIGN KEY FK_C3EAB4D46EA0599A');
        ...
        $this->addSql('ALTER TABLE challenge_batch DROP FOREIGN KEY FK_FCD9DBC6E48FD905');
        ...
        $this->addSql('ALTER TABLE challenge_batch DROP FOREIGN KEY FK_FCD9DBC6A76ED395');
        ...
        $this->addSql('DROP TABLE challenge_batch');
        $this->addSql('DROP TABLE challenge_batch_challenge');
